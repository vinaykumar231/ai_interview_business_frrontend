...
const ServiceSection: React.FC<ServiceSectionProps> = () => {
  const services = [
    ...
    { title: "Digital Marketing", description: "Our Team works best when it has a purpose that will create value. We create experiences that automate sell and are great to use", color: "bg-red-500" }
  ];

  return (
    <section className="flex flex-col items-start self-center py-9 pr-20 mt-44 ml-5 w-full text-white rounded-3xl max-w-[2220px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
      <div className="flex flex-wrap gap-10 items-start text-4xl font-extrabold leading-10 uppercase">
      ...
      <div className="flex flex-wrap gap-5 justify-between mt-11 max-w-full w-[1184px] max-md:mt-10">
