  ...
  return (
    <div className="flex flex-col w-[42%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col mt-96 max-md:mt-10 max-md:max-w-full">
        <h2 className=" grad-text self-start text-4xl font-extrabold tracking-tighter leading-none uppercase bg-clip-text bg-[linear-gradient(180deg,#F24E1E_0%,#A259FF_100%)] max-md:max-w-full">
          {title}
        </h2>
